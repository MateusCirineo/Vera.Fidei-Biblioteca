...
PATRISTIC_AUTHORS: dict[str, dict] = {
    ...
    "Santo Agostinho de Hipona": {
        ...
        "works": [r"confessione", r"civitate\s+dei", r"de\s+trinitate",
                  ...
                  r"de\s+libero\s+arbitrio", r"coment[aá]rio\s+aos\s+salmos",
                  r"enarrationes\s+in\s+psalmos", r"solil[oó]quios",
                  r"soliloquia", r"a\s+vida\s+feliz", r"de\s+beata\s+vita"],
        "collection": "PL",
        "tradition": "latina",
    },
...
AUTHOR_ALIASES: dict[str, str] = {
    ...
    "sao inacio de antioquia":      "Santo Inácio de Antioquia",
    "são inácio de antioquia":      "Santo Inácio de Antioquia",
    ...
    "inacio aos magnesios":         "Santo Inácio de Antioquia",
    "inácio aos tralianos":         "Santo Inácio de Antioquia",
    "inacio aos tralianos":         "Santo Inácio de Antioquia",
    "inácio aos filadelfienses":    "Santo Inácio de Antioquia",
    "inacio aos filadelfienses":    "Santo Inácio de Antioquia",
    "inácio aos esmirnenses":       "Santo Inácio de Antioquia",
    "inacio aos esmirnenses":       "Santo Inácio de Antioquia",
    "inácio aos esmirniotas":       "Santo Inácio de Antioquia",
    "inacio aos esmirniotas":       "Santo Inácio de Antioquia",
    "carta aos filadelfienses":     "Santo Inácio de Antioquia",
    "carta aos esmirniotas":        "Santo Inácio de Antioquia",
    "carta aos esmirnenses":        "Santo Inácio de Antioquia",
    ...
    "comentario aos salmos":            "Santo Agostinho de Hipona",
    "enarrationes in psalmos":          "Santo Agostinho de Hipona",
    "soliloquios":                      "Santo Agostinho de Hipona",
    "a vida feliz":                     "Santo Agostinho de Hipona",
    "de beata vita":                    "Santo Agostinho de Hipona",
    # Ambrósio de Milão
