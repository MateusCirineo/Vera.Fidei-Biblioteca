...
// Agrupa livros por canonical_title ?? title dentro de cada autor
        ...
        <div className="space-y-2">
          {withBooks.map((entry) => {
            ...
            return (
              <div
                key={entry.name}
                className="rounded-lg border border-fundo-borda overflow-hidden"
              >
                {/* Cabeçalho do autor */}
                <button
                  onClick={() => {
                    setOpenAuthor(isAuthorOpen ? null : entry.name)
                    setOpenWork(null)
                  }}
                    ...
                    {works.map(({ title, books }) => {
                      ...
                      return (
                        <div key={title}>
                          <button
                            onClick={() =>
                              setOpenWork(isWorkOpen ? null : workKey)
                            }
